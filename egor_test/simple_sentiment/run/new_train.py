...
with open('../input/positive.csv', mode='r', encoding='utf-8') as csv_file:
    ...
    for row in csv_reader:
        if line_count == 0:
            ...
            line_count += 1
            continue
        raw_train.append({'id':row["time"], "text":row["text"],'sentiment':"positive"})        
        line_count += 1
...
with open('../input/positive.csv', mode='r', encoding='utf-8') as csv_file:
    ...
    for row in csv_reader:
        if line_count == 0:
            ...
            line_count += 1
            continue
        raw_train.append({'id':row["time"], "text":row["text"],'sentiment':"negative"})        
        line_count += 1
    print(f'Processed {line_count} lines.')
